...
function Login() {
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleLogin = async ()=>{
        try {
            ...
            if (!res.ok) {
                ...
                setMessage("Bem-vindo(a) de volta, ".concat(data.name || email, "!"));
                login({
                    id: data.id,
                    name: data.name,
                    email: data.email,
...
_s(Login, "dn1DQCgEDmZqFBtpqSg3iabgvTU=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a43d3e7._.js.map