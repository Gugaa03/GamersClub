...
function GamePage() {
    ...
    // Comprar agora: envia para checkout com query string
    const handleBuyNow = ()=>{
        if (!game) return;
        router.push("/checkout?gameId=".concat(game.id));
    };
...
_s(GamePage, "w8I6q3JTVyHHkkaVWRvhbIhwI4E=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b514d52._.js.map