...
function CheckoutPage(param) {
    let { cart = [] } = param;
    _s();
    const { user, addFunds } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"])(); // useAuth deve ter addFunds ou método de atualizar saldo
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Garantir que cart é array
    const totalPrice = Array.isArray(cart) ? cart.reduce((acc, g)=>acc + (g.price || 0), 0) : 0;
    const handlePurchase = async ()=>{
        if (!user) return alert("Faça login primeiro!");
        if ((user.balance || 0) < totalPrice) return alert("Saldo insuficiente!");
        setLoading(true);
        try {
            // Aqui você chamaria o backend real
            ...
            addFunds(newBalance - (user.balance || 0)); // ajusta para o novo saldo
...
_s(CheckoutPage, "koPADlaAQ7EaYbykLXAt2QQuAl8=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0ab0f1a._.js.map