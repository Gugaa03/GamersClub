...
function CheckoutPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CheckoutPage.useEffect": ()=>{
            ...
            async function fetchGame() {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("games").select("*").eq("id", gameId).single();
                if (error) {
                    console.error(error);
                } else {
                    setGame(data);
    ...
    if (!game) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        className: "text-white text-center mt-20",
        children: "Carregando jogo..."
    }, void 0, false, {
    ...
    const handlePurchase = async ()=>{
        ...
        try {
            // Registrar a compra
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("purchases").insert({
                user_id: user.id,
                game_id: game.id,
                price: game.price
            });
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("users").update({
                balance: newBalance
            }).eq("id", user.id);
            alert("Compra de ".concat(game.title, " realizada com sucesso!"));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center gap-4 bg-gray-800 p-4 rounded-lg mb-6",
                children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: loading ? "Processando..." : "Comprar Agora"
            }, void 0, false, {
                fileName: "[project]/pages/Checkout.tsx",
                lineNumber: 73,
                columnNumber: 7
...
_s(CheckoutPage, "XOuosUaC2GlMFZ8/Jnfd4AYvh68=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f29ff266._.js.map