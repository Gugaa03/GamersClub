...
const AuthProvider = (param)=>{
        ...
        "AuthProvider.useEffect": ()=>{
            const loadSession = {
                "AuthProvider.useEffect.loadSession": async ()=>{
                    var _data_session;
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if ((_data_session = data.session) === null || _data_session === void 0 ? void 0 : _data_session.user) {
                        const userId = data.session.user.id;
                        var _data_session_user_email;
                        const email = (_data_session_user_email = data.session.user.email) !== null && _data_session_user_email !== void 0 ? _data_session_user_email : "";
                        // buscar dados extras na tabela "users"
                        const { data: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("balance, nickname, name").eq("id", userId).single();
                        setUser({
                            id: userId,
                            email,
                            balance: (userData === null || userData === void 0 ? void 0 : userData.balance) || 0,
                            nickname: userData === null || userData === void 0 ? void 0 : userData.nickname,
            ...
            const { data: listener } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthProvider.useEffect": (_event, session)=>{
                    if (session === null || session === void 0 ? void 0 : session.user) {
                        ...
                        setUser({
                            id: session.user.id,
                            email: (_session_user_email = session.user.email) !== null && _session_user_email !== void 0 ? _session_user_email : "",
                            balance: 0
                        });
    ...
    // 🔄 Função de login (manual, se precisares)
    ...
    const refreshBalance = async (userId)=>{
        ...
        if (!id) return;
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("balance").eq("id", id).single();
    ...
    const addFunds = async (amount)=>{
        ...
        if (error) {
            ...
            return alert("Erro ao atualizar saldo no Supabase.");
        }
        setUser({
            ...user,
            balance: newBalance
    ...
    // 📝 Atualizar perfil (nickname e/ou name)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a369ee5._.js.map