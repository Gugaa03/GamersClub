...
function CheckoutPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        async function fetchGame() {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("games").select("*").eq("id", gameId).single();
            if (error) {
                console.error(error);
            } else {
                setGame(data);
    ...
    const handlePurchase = async ()=>{
        ...
        try {
            // Registrar a compra
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("purchases").insert({
                user_id: user.id,
                game_id: game.id,
                price: game.price
            });
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("users").update({
                balance: newBalance
            }).eq("id", user.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d75e203._.js.map